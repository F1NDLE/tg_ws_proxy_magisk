...
* Action Button: Запуск и открытие веб ui модуля 
...
2. Нажмите Action
3. Вас перекинет в KsuWEBUI (если его не будет - модуль установит его сам)
4. нажмите на кнопку старта и открыть TG. Вас перекинет в Telegram. Нажмите подключить прокси
